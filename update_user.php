            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col inputGroupContainer">
                    <div class="input-group">
                      <input  name="user_name" placeholder="User name" class="form-control"  type="text" disabled="true">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col inputGroupContainer">
                    <div class="input-group">
                      <input  name="vat_number" placeholder="VAT number" class="form-control"  type="text">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col inputGroupContainer">
                    <div class="input-group">
                      <input  name="registration_number" placeholder="Registration number" class="form-control"  type="text">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col inputGroupContainer">
                    <div class="input-group">
                      <input  name="payment_terms" placeholder="Payment terms" class="form-control"  type="text" disabled="true">
                    </div>
                  </div>
                </div>
                <div class="form-group">
